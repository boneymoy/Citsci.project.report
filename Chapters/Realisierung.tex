    ...
    \section{Vorverarbeitung}\label{sec:Preprocessing}
        ...
        \subsection{Wie wird ein System Call dargestellt?}\label{sec:syscalldarstellung}
            ...
            \paragraph{Word2Vec}
                ...
                Dabei werden Wörter aus einem gegebenen Satz an möglichen Wörtern anhand eines Trainingsdatensatzes in dichte Vektoren $v$ fester Länge $embed\_size$ kodiert.
                ...
                Dies wird erreicht, indem Worte nicht einzeln betrachtet werden, sondern immer in einem Kontext.
            ...
            \paragraph{System Call Argumente}  
                ...
                Gleichzeitig soll dabei aber nicht einzelne Angriffe genutzt werden um diese Faktoren zu ermitteln, da sonst die Gefahr besteht in die Richtung der signaturbasierten IDS zu gelangen, was wie in \autoref{sec:Datenanalyse} ungewollte Nachteile hätte.
