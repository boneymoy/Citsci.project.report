...
\section{Vorverarbeitung}
    ...
    \subsection{Wie wird ein System Call dargestellt?}
        ...
        Durch \texit{Word embeddings} kann zusätzlich zu der Kategorie auch versucht noch der Konext des Wortes im in der Repräsentation einzubinden.
        %TODO Abschnitt w2v
    ...
    \subsection{Wie werden System Call Parameter dargestellt?}
    ...
    \subsection{Wie können zusätzliche Metadaten kodiert werden?}
