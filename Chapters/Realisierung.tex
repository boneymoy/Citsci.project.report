...
%*****************************************
    ...
    \section{Algorithmus}\label{sec:Algorithmus}
        ...
        \subsection{Allgemein}\label{sec:Allgemein}
            ...
            In diesem Ausschnitt darf kein Angriffsverhalten enthalten sein.
            Eine Garantie die in der echten Welt nie komplett gegeben werden kann.
            Da in dem Ausschnitt kein Alarm auftreten darf, wird der höchste Anomaliescore als Schwellwert gewählt.
        ...
        \subsection{Training}\label{sec:Training}
            ...
            200 Training - nur Normal
            50 Validierung - nur Normal
            Rest Test - Normal und Angriffsverhalten
