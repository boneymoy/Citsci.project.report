...
%*****************************************
    ...
    \section{Algorithmus}\label{sec:Algorithmus}
        ...
        \subsection{Allgemein}\label{sec:Allgemein}
            ...
            Die Wahrscheinlichkeit des tatsächlich auftretenden System Calls von eins abgezogen, stellt dann den Anomaliescore dar.\par\medskip
            ...
            In den Validierungsdaten darf folglich kein Alarm ausgelöst werden, weshalb der höchste Anomaliescore der Validierungsdaten als Schwellwert der Anomalieerkennung verwendet wird.
            Dies ist eine Annäherung an einen optimalen Schwellwert.\par\medskip
...
\section{Metriken}\label{sec:Metriken}
    ...
    Für zweckdienliche Metriken ist die Bereitstellung von einheitlichen und vom Datensatz unabhängige Messwerte essentiell.
    ...
    Ziel ist es also, eine hohe \ac{DR} und eine möglichst geringe \ac{FP}-Rate zu erreichen.\par\medskip
