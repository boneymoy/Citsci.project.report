    ...
    \section{Algorithmus}\label{sec:Algorithmus}
        ...
        \subsection{Parameterwahl}\label{sec:parameterwahl}
            ...
            \paragraph{Festgelegte Parameter}
                ...
                Für die Loss-Funktion wurde die CrossEntropy gewählt.
                Und der in vielen Bereichen eingesetzte Adam-Optimizer.
                Wie auch in \autoref{smth} erkennbar ist stagniert der Fehler nach nur wenigen Epochen, weshalb diese auf $20$ festgelegt werden.

                Es werden aufgrund der Ergebnissen von Grimmer et al.~\cite{IDSTHREADGRIMMER2021} nur n-gramme aufgebaut mit Betrachtung der Thread Information.



            \paragraph{Zu ermittelnde Parameter}
                Für die Ergebnisqualität mit entscheidende Faktoren sind vor allem die Länge der n-gramme.
                Einstellbar ist außerdem die Vektorgröße des \ac{W2V}.
...
\section{Metriken}\label{sec:Metriken}
    ...
    \begin{figure}
        ...
        \caption{Berechnungen der häufig verwendeten Metriken der Precision und des Recalls.}\label{fig:metriken}
    \end{figure}
    ...
    Wie in \autoref{sec:prob_LIDDS} beschrieben liefert der Datensatz nur den Angriffszeitpunkt.
    ...
    Wird von einem optimalen Fall ausgegangen, dass alle dem Angriff zugehörigen System Calls einen Alarm auslösen, wird der Recall immer noch sehr niedrig sein.
    ...
    Die Grundidee der verwendeten Metriken besteht darin, Alarme welche nach dem Angriffszeitpunkt in einer Aufnahme mit Angriffsverhalten auftreten als korrekt zu werten.
    Zusätzlich gilt dann diese Aufnahme als korrekt erkannt.
    Die \ac{} 
