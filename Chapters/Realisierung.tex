...
%*****************************************
        ...
        \subsection{Darstellung weiterer Parameter}\label{sec:Meta}
                ...
                \paragraph{Zeitliche Abstände von System Calls}
                    ...
                    \begin{figure}
                        ...
                        \caption[ass]{Dargestellt ist der zeitliche Abstand zwischen zwei System Calls aus dem selben Thread.
                ...
                \paragraph{Return Werte}
                    ...
                    \begin{figure}[ht]
                        ...
                        \caption[ass1]{Histogramm der gelesenen/erhaltenen Bytes für die Testdaten des \ac{LID-DS}~\cite{LID-DS} $CVE-2017-7529$ Szenarios.
        ...
        \subsection{Darstellung eines System Call Streams}\label{sec:streamdarstellung}
            ...
            \paragraph{Thread Awareness}
                ...
                \begin{figure}
                    ...
                    \caption[ass2]{Erstellung der n-gramme mit $n=2$ aus einem Datenstream von System Calls.
    ...
    \section{Aufbau LSTM}\label{sec:aufbau_lstm}
        \begin{figure}[ht]
            ...
            \caption[ass4]{Aufbau des \ac{LSTM} mit $64$ Neuronen für die \ac{LSTM}- und Linear-Layer.
    ...
    \section{Algorithmus}\label{sec:Algorithmus}
        ...
        \subsection{Training}\label{sec:Training}
            \begin{figure}
                ...
                \caption[ass44]{Ablauf der Trainingsphase mit Beispieldaten.
        ...
        \subsection{Anomalieerkennung}\label{sec:Anomalieerkennung}
            \begin{figure}[ht]
                ...
                \caption[ass2]{Ähnlich zu \autoref{fig:training} wird hier der Validierungsablauf beschrieben.
        ...
        \subsection{Parameterwahl}\label{sec:parameterwahl}
            ...
            \paragraph{Festgelegte Parameter}
                ...
                \begin{figure}
                    ...
                    \caption[ass]{Darstellung der Lernrate für zwei Szenarien.
...
\section{Metriken}\label{sec:Metriken}
    ...
    \begin{figure}
        ...
        \caption[ass]{Visualisierung der Berechnung der häufig verwendeten Metriken der Precision und des Recalls, bezogen auf die Domäner der \textit{Intrusion Detection}.}\label{fig:metriken}
    \end{figure}
