...
\section{NLP in der Anomaliedetektion und HIDS}\label{sec:related_nlp}
        ...
        Auch die in der Textverarbeitung verwendeten \ac{LSTM} Netzwerke finden Anwendung in der \ac{HIDS}.
        ...
        Park et al.\ hingegen verwenden denselben Datensatz wie diese Arbeit, greifen bei der Auswertung aber auf Metriken zurück welche in diesem Kontext nur wenig Aussagekraft besitzen, wie in~\autoref{sec:Metriken} beschrieben.
