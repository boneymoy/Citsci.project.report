...
\section{Berechnungsdauer}\label{sec:erg_time}
    ...
    \end{table}
    Wie zu erkennen ist benötigen die beiden größten Szenarien trotz der besseren Grafikkarte wesentlich länger.
...
\section{LSTM Ansatz}\label{sec:erg_LSTM}
    ...
    \begin{table}[ht]
        ...
        \begin{tabular}{rrrr}
            ...
            \hline
        \end{tabular}
        \caption[Ergebnisse \ac{FP} ohne Extraparameter]{Konfigurationen mit den $10$ niedrigsten \acp{FP}. 
                 Dabei wurden nur Konfigurationen betrachtet die keine Extraparameter nutzen.
                 Alle N-Gramme sind \textit{Thread Aware}.
...
\section{Extra Parameter}\label{sec:erg_LSTM_extra}
    ...
    \begin{table}[ht]
        ...
        \begin{tabular}{rrrrrrr}
            ...
            \hline
        \end{tabular}
        \caption[Ergebnisse \ac{DR} mit Extraparametern]{Konfigurationen mit den $10$ höchsten \acp{DR}. 
    ...
    Interessant ist, dass auch hier wieder die Konfiguration $n=10$ und $e=4$ unter den besten Ergebnissen auftaucht und das die beiden besten Ergebnisse\marginpar{nach \ac{DR} und \ac{FP}} durch die Konfiguration $n=6$ und $e=8$ erreicht wurden.
    ...
    \begin{table}[ht]
        ...
        \begin{tabular}{rrrrrlr}
            ...
            \hline
        \end{tabular}
        \caption[Ergebnisse \ac{FP} mit Extraparametern]{Konfigurationen mit den $10$ niedrigsten \ac{FP}-Raten. 
    ...
    \begin{table}[ht]
        ...
        \begin{tabular}{lrrrr}
            ...
            $PHP\_CWE-434$         &$13.22$ &{\color{CTred}$3.13$} & 	$0.91$  &{\color{CTlink}$0.00$}\\
            \rowcolor{GruvGray!16}
            $SQL\_Injection\_CWE-89$&$25.51$ &{\color{CTred}$15.70$}& 	$0.99$  &{\color{CTlink}$0.04$}\\
            \rowcolor{CTred!16}
    ...
    In  \autoref{tab:LSTM_vs_alternative} und \autoref{tab:LSTM_vs} werden die zwei Gewinnerkonfigurationen aus \autoref{tab:LSTM_par_erg} und \autoref{tab:LSTM_FP} mit jeweils den Gewinnerkonfigurationen ohne Extraparametern gegenübergestellt.
    ...
    \begin{table}[H]
        ...
        \begin{tabular}{lrrrrr}
            ...
            CVE-2012-2122 	      & $8$ & $0.01$ & x & {\color{CTred}$18$} &{\color{CTlink}$0.99$} \\
            \rowcolor{GruvGray!16}
            CVE-2014-0160 	      & $3$ & $0.00$ & x & {\color{CTred}$13$} &{\color{CTlink}$0.03$} \\
            ...
            \rowcolor{GruvGray!16}
            EPS CWE-434 	      & $14$ & $1.00$ & x & {\color{CTred}$29$} &{\color{CTlink}$1.00$} \\
            PHP CWE-434 	      & $4$ & $0.96$ & x & {\color{CTred}$24$} &{\color{CTlink}$.1.00$} \\
            \rowcolor{GruvGray!16}
            SQL Injection CWE-89 &	$1$ & $0.46$ & x & {\color{CTred}$82$} &{\color{CTlink}$1.00$} \\
    ...
    \begin{table}[H]
        ...
        \begin{tabular}{lrrrrr}
            ...
            \toprule
            \rowcolor{GruvGray!16}
            Bruteforce CWE-307    & $15$ & $1.00$ & x & {\color{CTlink}$10$} &{\color{CTred}$0.07$} \\
            CVE-2012-2122 	      & $4$ & $0.03$& x & {\color{CTred}$10$} &{\color{CTlink}$0.02$} \\
            \rowcolor{GruvGray!16}
            CVE-2014-0160 	      & $1$ & $0.99$ & x & {\color{CTred}$5$} &{\color{CTred}$0.00$} \\
            CVE-2017-7529 	      & $0$  & $0.05$ & x & {\color{CTred}$3$} &{\color{CTlink}$0.99$} \\
            \rowcolor{GruvGray!16} 
            ...
            \hline
        \end{tabular}
        \caption[Vergeleich \ac{FP} ohne Extraparameter vs.\ mit Extraparameter ]{Vergleich bester Ergebnisse.
...
\section{Vergleich anderer Arbeiten}\label{sec:erg_vgl}
    ...
    Insgesamt erkennbar, dass der \ac{LSTM}-Ansatz auf allen Leveln bis auf Level $5$ ähnlich gut abschneidet.
