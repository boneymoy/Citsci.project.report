...
\section{Strukturierung der Experimente}
    ...
    Danach sollen auch die zusätzlichen Parameter eingebunden werden und es soll untersucht werden inwiefern sich die Extraparameter auf die Ergebnisse auswirken.
    ...
    Da aber eine beste Konfiguration gesucht wird, könnte es sein, dass viele Konfiguration bis auf die Beste schlecht abschneiden und damit den Mittelwert entscheidend verschlechtert.
    Nichtsdestotrotz wird in \autoref{sec:erg_LSTM_extra} versucht durch verschiedene Darstellungen einen sinnvollen Vergleich zu ziehen. 
...
\section{Extra Parameter}\label{sec:erg_LSTM_extra}
    ...
    Auffällig dabei ist, dass wie in \autoref{tab:LSTM_erg} kein ersichtlicher Zusammenhang zwischen der Anzahl der Eingangsneuronen und Ergebnisqualität zu erkennen ist.
    ...
    Nur drei der besten zehn Ergebnisse verwenden keine Rückgabewerte.
    \begin{table}[ht]
        \centering
    ...
    Und wieder nur drei der besten zehn Ergebnisse enthält keinen Parameter.
