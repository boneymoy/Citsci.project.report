...
In den folgenden Abschnitten sollen nun Grundlagen betrachtet werden, welche bei der Umsetzung des \ac{IDS} nötig sind.
    ...
    \section{System Calls}\label{sec:syscalls}
        ...
        Dazu gehören verschiedene Bereiche der Prozesskontrolle, das Datei- und Geräte-Management, Informationspflege und Kommunikation.~\cite{SYSCALL_SILBERSCHATZ}
        ...
        \subsection{Datensätze}\label{sec:Datensatz}
            ...
            \paragraph{LID-DS}
                ...
                In Tabelle~\ref{tab:scenarien} werden die verschiedenen Schwachstellen als \ac{CVE}
