...
%*****************************************
    ...
    \section{Intrusion Detection System}\label{sec:IDS}
        Eine \textit{Intrusion} \marginpar{zu dt. Eindringen, Einbruch} ist eine unautorisierte Aktivität welche zu Missbrauch eines Systems oder zumindest anormalen Verhalten führen und einem System großen Schaden zufügen kann.
        ...
        Das Erkennen von Angriffen auf Computersystemen mittels \ac{IDS} wird im wesentlichen in zwei Kategorien eingeteilt.~\cite{IDSreview, IDSsurvey, IDSsurvey2}.
            ...
            \paragraph{Anomaliebasiert}
                ...
                Dabei wird in \ac{ML}-basierte, Statistik-basierte~\cite{IDSPIETRO2008} oder auch 
                wie in machen Arbeiten~\cite{IDSsurvey} zusätzlich in die \textit{Knowledge}-basierten \marginpar{zu dt. Wissens-basierte} Algorithmen untergliedert.
        ...
        \subsection{Datensätze}\label{sec:Datensatz}
            ...
            \subsubsection{LID-DS}
                ...
                \paragraph{Problem des Datensatzes}
                    ...
                    Befindet sich der Anomaliescore vor dem Angriffszeitpunkt $t_{Angriff}$ unter dem Schwellwert, also im Quadrant 3 der Abbildung, kann von einem \textit{True Negative} ausgegangen werden.
                    Also es wurde korrekterweise kein Alarm vorhergesagt.
                    Befindet sich der Anomaliescore vor dem Angriffszeitpunkt $t_{Angriff}$ über dem Schwellwert, also im Quadrant 2, liegt ein \textit{False Positive} vor.
                    ...
                    Denn liegt der Anomaliescore nach dem Angriffszeitpunkt über dem Schwellwert, also im Quadranten 1, wird von einem \textit{True Positive}, also einem korrektem Alarm ausgegangen.
                    ...
                    Genauso könnte umgekehrt ein Anomaliescore unter dem Schwellwert, also im Quadranten 4 korrekt sein obwohl er als \textit{False Negative} gewertet werden müsste.
                    ...
                    In~\autoref{sec:metrik} wird eine Lösungsmöglichkeit betrachtet.

                \begin{table}[ht]
                    \scriptsize
                    \centering
                    \begin{tabular}{p{1.1cm}p{1.1cm}p{0.4cm}p{0.6cm}p{0.6cm}p{0.8cm}p{0.6cm}p{1.3cm}}
                        \rowcolor{Gray!36}
                        \hline
