...
In den folgenden Abschnitten sollen nun Grundlagen betrachtet werden, welche bei der Umsetzung des \ac{IDS} nötig sind.
    ...
    \section{Intrusion Detection System}\label{sec:IDS}
        Eine \textit{Intrusion} \marginpar{zu dt. Eindringen, Einbruch} ist eine unauthorisierte Aktivität, welche einem System Schaden zufügen kann.
        ...
        Die letztere Frage soll speziell in Kapitel~\ref{sec:Algorithmus} beleuchtet werden, doch wie das Systemverhalten präzise dargestellt werden kann soll nun behandelt werden.
            ...
            Wobei System-Logs nur durch das \ac{OS}\marginpar{zu dt. Betriebssystem} geschrieben werden.
            Für beide trifft jedoch zu, dass sie das Systemverhalten beschreiben aber bereits eine starke Filterung stattfindet.
            Desweiteren müssen die Filter manuell eingestellt werden.
            ...
            {\color{red} Da verarbeitende Algorithmen besser geworden sind und Computer schneller kann auf Filterung verzichtet werden und System Calls verwendet werden.}
