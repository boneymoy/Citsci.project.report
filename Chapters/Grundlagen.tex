        ...
        \subsection{Datenerfassung}\label{sec:Datenerfassung}
            ...
            \paragraph{Host-Daten zur Beschreibung des Systemverhaltens}
                ...
                \begin{figure}[ht]
                    ...
                    \caption[Einordnung der Arbeit in die Struktur der \ac{IDSs}]{Einordnung des verwendeten \ac{IDS} (Relevant für diese Arbeit dicker markiert).}\label{fig:IDSOverview}
                \end{figure}
    ...
    \section{Künstliche neuronale Netze}\label{sec:KNN}        
        ...
        \subsection{Rekurrente neuronale Netze}\label{sec:RNN}
            ...
            Dabei werden für die Übersichtlichkeit Gewichte sowie der Bias nicht dargestellt.
                ...
                \begin{figure}[ht]
                    ...
                    \caption[Alternative Darstellung einer RNN Zelle]{Darstellung einer \glqq ausgerollten\grqq \ und vereinfachten RNN Zelle}
        ...
        \subsection{Long Short-Term Memory}\label{sec:LSTM}
            ...
            \begin{figure}[ht]
                ...
                \caption[Schematische Darstellung einer \ac{LSTM} Zelle - Memory Cell]{Schematische Darstellung eine Memory Cell $A$ in einem LSTM NN, mit Input, Output und Forget Gate (Abwandlung von \cite{OLAH2015}).}
                \label{fig:LSTM}
            \end{figure}
