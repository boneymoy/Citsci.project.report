...
%
        ...
        \label{sec:RNN}
            ...
            \paragraph{Long Short-Term Memory} 
                ...
                Und um zu erlenen welche früheren Ausgaben für die Ermittlung nächster Datenpunkte entscheident sind, wird an jedem Knoten eine \textit{Memory Cell} \marginpar{zu dt. Gedächtniszelle} angebracht, zu sehen ist diese Erweiterung in Abbildung~\ref{fig:LSTM}.
    ...
    \label{sec:Datensatz}
        ...
        pro scenario ca. 1000 files welche jeweils ca 60sec aufnahmen beinhalten, insgesamt ca 10h trainingsdaten pro scenario
