    ...
    \section{Intrusion Detection System}\label{sec:IDS}
        ...
        Das Erkennen von Angriffen auf Computersystemen mittels \ac{IDS} wird im wesentlichen in zwei Kategorien eingeteilt.~\cite{IDSreview, IDSsurvey, IDSsurvey2}.
            ...
            \paragraph{Anomaliebasiert}
                ...
                Das Normalverhalten oder anders formuliert das Modell eines Systems im Normalzustand soll möglichst akkurat das zu erwartende Systemverhalten, ohne unerwünschtes Verhalten also zum Beispiel Angriffe, beschreiben.
                Anomalien des Verhaltens können zu signifikanten und oft kritischen Veränderungen eines Systems führen. 
                ...
                Jedoch sind auch \textit{unsupervised} Trainingsverfahren  möglich welche keine Anomalien in den Daten enthalten.{\color{red}\textit{QUELLE}}
        ...
        \subsection{Datenerfassung}\label{sec:Datenerfassung}
            ...
            \paragraph{Host Based Intrusion Detection}
                ...
                Im Gegensatz zur \ac{NIDS} kann hier auf den Inhalt von jeder Information eingegangen werden, da die interne Kommunikation unverschlüsselt stattfindet. 
