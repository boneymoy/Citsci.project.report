    ...
    \section{System Calls}\label{sec:syscalls}
        ...
        \begin{table}[ht]
            ...
            \begin{tabular}{cp{4cm}p{2cm}p{3cm}}
                ...
                \hline
            \end{tabular}
            \caption[ass]{Kurzbeschreibung ausgewählter System Calls}
            \label{tab:syscall}
        \end{table}
            ...
            \paragraph{\ac{LID-DS}}\label{sec:LIDDS}
                ...
                \begin{table}[]
                    ...
                    \begin{tabular}{p{3cm}p{6.5cm}}
                        ...
                        \hline
                    \end{tabular}
                    \caption[ass]{Kurzbeschreibung der in dem Datensatz vorkommenden Szenarien und den dazugehörigen Sicherheitslücken~\cite{LIDDS}}
                    \label{tab:scenarien}
                \end{table}
                ...
                \begin{table}[ht]
                    ...
                    \end{tabular}
                    \caption[ass]{Ausschnitt aus der runs.csv des \ac{LID-DS}, welche unter anderem die Labels für Angriffsfiles und Normalfiles enthalten.~\cite{LIDDS}}
                    \label{tab:runsfile}
                \end{table}
                \begin{table}[ht]
                    \scriptsize
                    ...
                    \begin{tabular}{l || g | l | g}
                        ...
                        \hline
                    \end{tabular}
                    \caption[ass]{Ausschnitt aus den eigentlichen Aufzeichnungen von System Calls aus dem \ac{LID-DS}~\cite{LIDDS}}
                    \label{tab:syscallfile}
                \end{table}
                \paragraph{Problem des \ac{LID-DS}}\label{sec:prob_LIDDS}
    ...
    \section{Künstliche neuronale Netze}\label{sec:KNN}        
        ...
        \subsection{Rekurrente neuronale Netze}\label{sec:RNN}
            ...
            Dabei werden für die Übersichtlichkeit Gewichte sowie der Bias nicht dargestellt.
                ...
                \begin{figure}[ht]
                    ...
                    \caption[ass]{Darstellung einer \glqq ausgerollten\grqq \ und vereinfachten RNN Zelle}
        ...
        \subsection{Long Short-Term Memory}\label{sec:LSTM}
            ...
            \begin{figure}[ht]
                ...
                \caption[ass]{Schematische Darstellung eine Memory Cell $A$ in einem LSTM NN, mit Input, Output und Forget Gate (Abwandlung von \cite{OLAH2015}).}
                \label{fig:LSTM}
            \end{figure}
            ...
            Die Weitergabe des Status wird in~\autoref{fig:LSTM_Status} dargestellt.
                ...
                \begin{figure}[ht]
                    ...
                    \caption[ass]{Weitergabe des Zellstatus innerhalb eines Knotens (Abwandlung von \cite{OLAH2015}).}
            ...
            Kommt nun allerdings ein neues Pronomen in der Eingabe $x_t$, sollte das bisher gespeicherte Genus keinen Einfluss mehr haben.
                ...
                \begin{figure}[ht]
                    ...
                    \caption[ass]{Einfluss des Forget Gates auf den Zellstatus (Abwandlung von \cite{OLAH2015}).}
            ...
            \end{equation}
                ...
                \begin{figure}[ht]
                    ...
                    \caption[ass]{Einfluss des Input Gates auf den Zellstatus (Abwandlung von \cite{OLAH2015}).}
